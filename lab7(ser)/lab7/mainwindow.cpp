    ...
    ui(new Ui::MainWindow)
{
    ...
    QPixmap* pixBird = new QPixmap(":/bird.png");
    QPixmap* pixTree = new QPixmap(":/tree.png");
    ...
    scene->addEllipse(QRectF(950,15,40,40),QPen(Qt::black,4),QBrush(Qt::yellow));
    scene->addLine(950,35,930,45,QPen(Qt::yellow,4));
    QColor color(100,227,203);
    QGraphicsLineItem* lineItem1=scene->addLine(QLineF(10,10,10,460),QPen(color,2));
    lineItem1->setData(0,"Wall");
    QGraphicsLineItem* lineItem2=scene->addLine(QLineF(10,10,1000,10),QPen(color,2));
    lineItem2->setData(0,"Wall");
    QGraphicsLineItem* lineItem3=scene->addLine(QLineF(1000,10,1000,460),QPen(color,2));
    lineItem3->setData(0,"Wall");
    QGraphicsLineItem* lineItem4=scene->addLine(QLineF(10,460,1000,460),QPen(color,2));
