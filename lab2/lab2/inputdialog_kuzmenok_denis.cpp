...
InputDialog_Kuzmenok_Denis::InputDialog_Kuzmenok_Denis(QWidget *pwgt) : QDialog(pwgt)
{
...
QString InputDialog_Kuzmenok_Denis::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Kuzmenok_Denis::lastName() const
{
